...
public class RPSLSpock {
    ...
    /* The method validates the users pick
    @param pick: Users input choice
    @return: True if pick is rock, paper, scissors, lizard, spock. False otherwise.
     */
    ...
    /*
    This method returns a randomly selected pick.
    @param: none
    @return: the String rock, paper, scissors, lizard, spock
     */
    ...
    /*
    This method checks the computers pick to see if it is winning the users pick.
    @param: c_pick - computers pick
    @param: h_pick - human or users pick
    @return: true if computer beats human and false otherwise.
     */
